...
console.log("Expected output of max(20,10) is 20 " + myFunctionTest(20, function () { return max(20, 10); }));
...
console.log("Expected output of isVowel('a') is true " + myFunctionTest(true, function () { return isVowel('a'); }));
...
console.log("Expected output of findLongestWord(['Hasib', 'Raashid', 'Pritom']) is Raashid " + myFunctionTest('Raashid', function () { return findLongestWord(['Hasib', 'Raashid', 'Pritom']); }));
...
console.log("Expected output of filterLongWords(['Hello', 'World', 'Go'], 2) is 'Hello,World' " + myFunctionTest(['Hello', 'World'], function () { return filterLongWords(['Hello', 'World', 'Go'], 2); }));
...
document.writeln("<br/> Multiply by 10: " + multiplyArray.toString() + "<br />");
